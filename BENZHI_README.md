...
- 项目：VanceMichael/go-annotation-29
...
1. 预期退出码 1：`go test ./internal/gateway/ -run "TestPollSurfacesContextError|TestPollDoesNotReportSuccessOnTimeout|TestPollHonoursCancel|TestPollAlreadyExpiredContext|TestSubmitAndPollSurfacesPollTimeout" -count=1`
